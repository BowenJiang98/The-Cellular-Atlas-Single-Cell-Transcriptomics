...
Idents(sce)<- "celltype"
sce <-subset(x = sce, idents = "Sertoli cells")
setwd("E:/Bowen-files/out/v5_addT90_new/Sertoli_cell/26_3_11")
...
pdf("Sertoli_cells_3group.pdf",width = 21,height = 7)
plot3
dev.off()

pdf("Sertoli_cells_group.pdf",width = 7,height = 7)
plot4
dev.off()

pdf("Sertoli_cells_umap.pdf",width = 7,height = 7)
plot1
dev.off()
save.image("Sertoli_cell.Rdata")
